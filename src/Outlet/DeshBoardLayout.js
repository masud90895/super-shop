...
const DeshBoardLayout = () => {
  ...
  return (
            ...
            <aside className="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
              <div>
                ...
                <div className="mt-8 text-center">
                  <img
                    src={user?.photoURL ? user.photoURL : "https://cdnb.artstation.com/p/assets/images/images/002/036/123/large/pablo-munoz-gomez-zbg-3d-avatar.jpg"}
                    alt=""
                  ...
                  <span className="hidden text-gray-400 lg:block">{userRole?.role}</span>
                </div>
    ...
    <div>
        ...
        <div className="mt-8 text-center">
            <img src={user?.photoURL ? user.photoURL : "https://cdnb.artstation.com/p/assets/images/images/002/036/123/large/pablo-munoz-gomez-zbg-3d-avatar.jpg"} alt="" className="w-10 h-10 m-auto rounded-full object-cover lg:w-28 lg:h-28"/>
            <h5 className=" mt-4 text-xl font-semibold text-gray-600 lg:block">{user?.displayName}</h5>
            <span className=" text-gray-400 lg:block">{userRole?.role}</span>
        </div>

        <ul className="space-y-2 tracking-wide mt-8">
            <li>
                <NavLink to="../deshboard" aria-label="dashboard" className={({isActive})=> `relative px-4 py-3 flex items-center space-x-4 rounded-xl  ${isActive ? "bg-gradient-to-r from-purple-600 to-purple-400 text-white" : "text-gray-600"}`} >
            ...
            <li>
                <NavLink to="allseller" className={({isActive})=> `relative px-4 py-3 flex items-center space-x-4 rounded-xl  ${isActive ? "bg-gradient-to-r from-purple-600 to-purple-400 text-white" : "text-gray-600"}`}>
            ...
            <li>
                <NavLink to="allbuyer" className={({isActive})=> `relative px-4 py-3 flex items-center space-x-4 rounded-xl  ${isActive ? "bg-gradient-to-r from-purple-600 to-purple-400 text-white" : "text-gray-600"}`} >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <li>
                <NavLink to="sellerrequest" className={({isActive})=> `relative px-4 py-3 flex items-center space-x-4 rounded-xl  ${isActive ? "bg-gradient-to-r from-purple-600 to-purple-400 text-white" : "text-gray-600"}`} >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <li>
                <NavLink to="reportedproduct" className={({isActive})=> `relative px-4 py-3 flex items-center space-x-4 rounded-xl  ${isActive ? "bg-gradient-to-r from-purple-600 to-purple-400 text-white" : "text-gray-600"}`} >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="w-1/2 hidden lg:flex">
                  <div className="w-full flex items-center pl-8 justify-end">
                    ...
                    >
                      ...
                      <p className="text-gray-800 text-sm mx-3">{user?.displayName}</p>
