            ...
            <div className="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
                ...
                <div className="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
                    ...
                    <div className="mt-6 sm:-mx-2">
                        <p className="inline-flex items-center justify-center w-full px-5 py-3 overflow-hidden text-white transition-colors duration-300 bg-gray-900 rounded-lg shadow sm:w-auto sm:mx-2   hover:bg-gray-800 focus:ring focus:ring-gray-300 focus:ring-opacity-80">
