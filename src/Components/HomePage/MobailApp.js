...
const MobailApp = () => {
    ...
    <div  className="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
        ...
        <div  className="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
            <h2  className="text-3xl font-semibold tracking-tight text-gray-800 xl:text-4xl  ">
                Download our mobile app to Best Experience
            </h2>

            <p  className="block max-w-2xl mt-4 text-gray-700  ">Download the official free Super Shop app on your phone for easy access to the largest classifieds marketplace in Bangladesh where you can buy, sell and search for a wide range of products, all on the go! Buy and sell anything from cars, motorcycles and other vehicles to mobile phones, laptops, TVs, cameras and much more. Search for property for rent & sale or apply for jobs in Bangladesh or jobs overseas, all on Super Shop.</p>

            <div  className="mt-6 sm:-mx-2">
                <a   className="inline-flex items-center justify-center w-full px-5 py-3 overflow-hidden text-white transition-colors duration-300 bg-gray-900 rounded-lg shadow sm:w-auto sm:mx-2 hover:bg-gray-700  bg-gray-800  hover:bg-gray-700 focus:ring focus:ring-gray-300 focus:ring-opacity-80">
