...
const Category = () => {
    ...
    return (
        <div className='mt-8 lg:mx-[100px]'>
           ...
           {
            categorys.map((category,i)=><button key={i} type="button" className="relative px-8 py-4 ml-4 overflow-hidden bg-gray-100  inline-block rounded border border-current  text-sm font-medium text-black transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring ">{category}
