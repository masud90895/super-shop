...
const AddProducts = () => {
                    ...
                    <div className="px-7 header flex bg-white lg:justify-around md:justify-around justify-start py-[30px] border-b-[2px] border-slate-100 flex-wrap gap-x-4 ">
                      <a className="cursor-pointer">
                        <div className="flex items-center instance group">
                          <div className="svg-container">
                            <svg
                              className="text-[#1E293B] group-hover:text-purple-700"
                              width={18}
                              height={18}
                              viewBox="0 0 18 18"
                              fill="none"
                          ...
                          <div className="pl-3 heading-container">
                            <p className="text-base font-medium leading-none text-slate-800 group-hover:text-purple-700 ">
                              General
                            </p>
                          </div>
                        </div>
                      ...
                      <a className="cursor-pointer">
                        <div className="flex items-center group">
                          ...
                          <div className="pl-3 heading-container">
                            <p className="text-base font-medium leading-none text-slate-700 group-hover:text-purple-700">
                              Customer
                            </p>
                          </div>
                        </div>
                  ...
                  <div className="block px-6 lg:hidden md:block">
                    <div className="relative top-1 ">
                      <div className="relative w-full mt-2 rounded outline-none dropdown-one bg-gray-50">
                        ...
                        >
                          <span
                            className="pr-4 text-sm font-medium text-purple-700  flex flex-row-reverse	 justify-end gap-x-2 "
                          ...
                          >
                            <div className="flex gap-x-2 ">
                              ...
                              <p className="text-base font-medium leading-none text-purple-700 mt-[1px]">
                                General
                              </p>
                            </div>
                          </span>
                          <div className="relative w-5 h-5 bg-purple-100 rounded">
                            <svg
                              id="rotate"
  ...
  flex flex-row-reverse	 justify-end gap-x-2
   ...
   w-full   p-3 text-base font-medium leading-none text-gray-600 group-hover:text-purple-700 mt-[1px] cursor-pointer group-hover:bg-purple-100 group-hover:font-medium group-hover:text-purple-700 group-hover:rounded"
                            >
                              General
                              <svg
                          ...
                          <div className="flex   gap-x-2 group">
                            <p
                              ...
                              className="
    flex flex-row-reverse	 justify-end gap-x-2
    text-base font-medium leading-none text-gray-600 group-hover:text-purple-700 mt-[1px] cursor-pointer group-hover:bg-purple-100 group-hover:font-medium group-hover:text-purple-700 group-hover:rounded w-full p-3"
                            >
                              Store
                              <svg
                                className=" group-hover:text-purple-700"
  ...
  text-base font-medium leading-none text-gray-600 group-hover:text-purple-700 mt-[1px] cursor-pointer group-hover:bg-purple-100 group-hover:font-medium group-hover:text-purple-700 group-hover:rounded w-full p-3"
                          ...
                          <div className="flex   gap-x-2 group">
                            <p
                              ...
                              className=" flex flex-row-reverse	 justify-end gap-x-2  text-base font-medium leading-none text-gray-600 group-hover:text-purple-700 mt-[1px] cursor-pointer group-hover:bg-purple-100 group-hover:font-medium group-hover:text-purple-700 group-hover:rounded w-full p-3"
                            >
                              Location
                              <svg
                                className=" group-hover:text-purple-700"
                          ...
                          <div className="relative w-full mt-2 border border-gray-300 rounded outline-none">
                            ...
                            >
                              <a href="" className="hover">
                                <p
                                  className="p-3 text-sm leading-none text-gray-600 cursor-pointer hover:bg-purple-100 hover:font-medium hover:text-purple-700 hover:rounded"
                  ...
                  <div className="flex flex-col flex-wrap items-center justify-center w-full px-7 lg:flex-row lg:justify-end md:justify-end gap-x-4 gap-y-4">
                    <button className="bg-white border-purple-700 rounded hover:bg-gray-50 transform duration-300 ease-in-out text-sm font-medium px-6 py-4 text-purple-700 border lg:max-w-[95px]  w-full ">
                      Cancel
                    </button>
                    <button className="bg-purple-700 rounded hover:bg-purple-600 transform duration-300 ease-in-out text-sm font-medium px-6 py-4 text-white lg:max-w-[144px] w-full ">
                      Save Changes
                    </button>
                  </div>
                </div>
