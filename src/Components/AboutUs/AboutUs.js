      ...
      <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
        <div className="w-full lg:w-6/12">
          <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
            We are here  to develop an efficient ecosystem for the e-Commerce industry
          </h2>
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            To develop an efficient ecosystem for the e-Commerce industry, the
            government has taken the initiative to establish an integrated and
            assisted eCommerce platform, “Super Shop”. Super Shop is the world’s first
            integrated assisted rural eCommerce platform. It has gathered all
            major eCommerce players and brought them to the country’s last-mile
            with integration in a single platform. Rural and urban merchants
            will be able to connect and collaborate with major e-Commerce and
            logistics players for shipment facilitation with the potential of
            global escalation. Super Shop utilises union-level delivery points to
            penetrate hard-to-access areas and government resources and human
            resources to make a decentralised supply chain. It enables sellers
            with a “Single Point of Entry”' to all e-Commerce platforms. Super Shop
            also leverages the use of ESCROW, a financial arrangement to
            temporarily hold money for a transaction before the transaction has
            been finalised to ensure maximum security for an e-commerce
            transaction.
          </p>
        </div>
        <div className="w-full lg:w-6/12">
