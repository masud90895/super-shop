    ...
    <div className="">
      <div className="bg-gray-200 lg:block hidden ">
        <div className=" flex font-normal py-2 justify-evenly text-black mx-[350px]">
          ...
          <Link className="hover:text-purple-900">BECOME A SELLER</Link>
          ...
          <Link className="hover:text-purple-900">ABOUT US</Link>
      ...
      <div className="lg:hidden mx-2 mt-2">
        <div className=" flex  justify-between">
          ...
          <div className="relative">
            <div className=" flex justify-between border rounded" onClick={() => setShow(!show)}>
            <div>
              <svg
            ...
            {show && (
                <ul className="visible z-50 transition duration-300 opacity-100 bg-white dark:bg-gray-800  shadow rounded mt-2 py-1 w-48 absolute">
