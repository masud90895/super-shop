      ...
      <div className="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2">
        <div className="mx-auto w-full  lg:mx-0">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            we are working with the most innovative teams in the world. you can join with us and make your life easy.
        ...
        <div className="mx-auto grid w-full grid-cols-2 items-end gap-y-12 sm:gap-y-14 lg:mx-0 lg:max-w-none ">
          <img
