  ...
  return (
    <div className="my-7 mx-3 ">
      ...
      <div className="my-5">
        ...
        {cart?.length > 0 ? (
          cart?.map((ct, i) => (
            <div key={ct._id} className="mt-5 border border-purple-600">
              ...
              <div className="shadow p-3 border">
                ...
                <div className="flex justify-between mt-10 gap-3 ">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <h1>
                        <small>No Warranty Available</small>
                      </h1>
                    </div>
                  </div>
                  <h1>${ct.price}</h1>
                ...
                <div className="mt-8 border shadow p-3">
                  ...
                  <div className="flex gap-2 items-center">
                    <h1 className="bg-orange-500 font-bold text-white p-1 text-sm rounded-lg mb-1">
                      Home
                    </h1>
          ...
          <div className="text-4xl text-center font-bold mt-9 text-red-600">
            No Order Found
          </div>
        )}
      </div>
